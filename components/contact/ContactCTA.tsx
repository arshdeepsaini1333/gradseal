      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              Start Your Fitness Learning Journey Today
            </motion.h2>
            ...
            >
              ...
              through GradSeal. Join them today.
            </motion.p>
            ...
            >
              <Link
                href="/courses"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white text-[#2563EB] font-bold text-sm hover:bg-blue-50 transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 w-full sm:w-auto justify-center"
              >
                Explore Courses
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl border-2 border-white/40 text-white font-bold text-sm hover:border-white hover:bg-white/10 transition-all w-full sm:w-auto justify-center"
              >
                Enroll Now
              </Link>
            </motion.div>
